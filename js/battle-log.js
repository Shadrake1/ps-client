...
var nodes=[];
var buttonContainer=this.innerElem.lastChild;for(var _i12=0,_this$innerElem$child4=
...
var hiddenText=hiddenCount===1?
TL(["("," line from "," hidden)"],hiddenCount,userid):
TL(["("," lines from "," hidden)"],hiddenCount,userid);
...
unlinkNodeList=function unlinkNodeList(nodeList){for(var _i18=0;_i18<
...
var nodeList=document.getElementsByClassName('chatmessage-'+userid);
BattleLog.unlinkNodeList(nodeList);
};_proto.
...
if(atIndex>=0){
var customRules=this.escapeHTML(formatid.slice(atIndex+3));
...
var inviteMessage=TL([""," invited you to join the room \"","\""],clickableName,roomid);
return[
'chat',
timestamp+"<em>"+inviteMessage+"</em>"+("<div class=\"notice\"><button class=\"button\" name=\"joinRoom\" value=\""+
roomid+"\">"+TL(["[Join ","]"],roomid)+"</button></div>")];
